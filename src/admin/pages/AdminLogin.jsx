        ...
        <div className="min-h-screen bg-gradient-to-br from-violet-50 via-white to-purple-50 flex items-center justify-center px-4 py-12">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-violet-600 text-white mb-4 transition-all duration-300">
                ...
                <div className="bg-white rounded-2xl shadow-xl shadow-violet-100/50 border border-gray-100 p-8">
                    ...
                    <form onSubmit={handleSubmit} noValidate className="space-y-5">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-10 pr-4 py-2.5 rounded-lg border text-sm outline-none transition-colors ${errors.email ? "border-red-400 ring-2 ring-red-100 bg-red-50" : "border-gray-300 focus:border-violet-400 focus:ring-2 focus:ring-violet-100 bg-white"}`}
                                />
                            </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-10 pr-10 py-2.5 rounded-lg border text-sm outline-none transition-colors ${errors.password ? "border-red-400 ring-2 ring-red-100 bg-red-50" : "border-gray-300 focus:border-violet-400 focus:ring-2 focus:ring-violet-100 bg-white"}`}
                                />
                        ...
                        <button type="submit" disabled={loading}
                            className="w-full py-2.5 rounded-lg bg-violet-600 hover:bg-violet-700 disabled:bg-violet-400 text-white font-semibold text-sm transition-colors flex items-center justify-center gap-2 cursor-pointer">
                            {loading ? (
                    ...
                    {/* Cross-portal navigation — NO register link for Admin */}
